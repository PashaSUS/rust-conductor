...
const categories: TechCategory[] = [
  {
    ...
    items: [
      ...
      { name: "Tonic", description: "gRPC framework built on Hyper and Tower", version: "0.13", url: "https://github.com/hyperium/tonic" },
  ...
  },
  {
    ...
    color: "text-blue-500",
    items: [
      { name: "PostgreSQL", description: "Primary relational database (via sqlx 0.8)", version: "17", url: "https://www.postgresql.org" },
      { name: "Redis", description: "Caching, state, and task queue (Redis Streams in DEV)", version: "8", url: "https://redis.io" },
      { name: "Apache Kafka", description: "Distributed event streaming (PROD task queue via rdkafka)", version: "0.37", url: "https://kafka.apache.org" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Vite", description: "Next-generation frontend build tool (SWC)", version: "8", url: "https://vite.dev" },
