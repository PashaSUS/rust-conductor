...
//!
//! `serde_json::Value` â†” `prost_types::Struct` is the core bridge: proto Struct
...
// ─────────────────────────────────────────────────────────────────────────────
// serde_json::Value â†” prost_types::Struct
// ─────────────────────────────────────────────────────────────────────────────
...
/// Helper: Option<Struct> â†’ HashMap<String, Value>.
...
/// Helper: HashMap â†’ Option<Struct>.
...
// ─────────────────────────────────────────────────────────────────────────────
// Owned (move) variants of core converters â€” avoids cloning on the hot path
// ─────────────────────────────────────────────────────────────────────────────
...
pub(crate) fn opt_string_owned(s: String) -> Option<String> {
...
// ─────────────────────────────────────────────────────────────────────────────
// Custom proto (package: conductor) â†” Rust model conversions
// ─────────────────────────────────────────────────────────────────────────────
...
// Re-export official proto conversions so existing `proto_conv::*` paths keep working.
pub use super::proto_conv_official::*;
